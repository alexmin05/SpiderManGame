...
public class BasicGameApp implements Runnable {
	...
	public Image wraparoundastroPic;
	...
	public Astronaut wraparoundastro;
	...
	public BasicGameApp() { // BasicGameApp constructor
		...
		wraparoundastroPic = Toolkit.getDefaultToolkit().getImage("astronaut.png"); //load the picture
		wraparoundastro = new Astronaut("astro",0 + astro.width,100); //construct the astronaut
		wraparoundastro.dy = 0;
